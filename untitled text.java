...
//        availableRooms.setOnAction(this::processAvailableRoomButtonForUser);
    ...
    {
    	 TableView<Rooms> table = new TableView<Rooms>();
         final ObservableList<Rooms> data =
                FXCollections.observableArrayList(
                        new Rooms(1, "1A", "Standard Suite"),
                        new Rooms(2, "1B", "Standard Suite"),
                        new Rooms(3, "1C", "Standard Suite"),
                        new Rooms(4, "1D", "Standard Suite"),
                        new Rooms(5, "2A", "Standard Suite"),
                        new Rooms(6, "2B", "Standard Suite"),
                        new Rooms(7, "2C", "Standard Suite"),
                        new Rooms(8, "2D", "Standard Suite"),
                        new Rooms(9, "3A", "Standard Suite"),
                        new Rooms(9, "3A", "Standard Suite"),
                        new Rooms(9, "3A", "Standard Suite"),
                        new Rooms(9, "3A", "Standard Suite"),
                );
         ...
         roomIdCol.setMinWidth(100);
         roomIdCol.setCellValueFactory(
                new PropertyValueFactory<Rooms, Integer>("roomId"));
                
         TableColumn roomNumberInCol = new TableColumn("Room Number");
         roomNumberInCol.setMinWidth(200);
         roomNumberInCol.setCellValueFactory(
                new PropertyValueFactory<Rooms, String>("roomNumberIn"));
                
         TableColumn roomTypeInCol = new TableColumn("Room Type");
         roomTypeInCol.setMinWidth(200);
         roomTypeInCol.setCellValueFactory(
                new PropertyValueFactory<Rooms, String>("roomTypeIn"));
                
        table.setItems(data);
        table.getColumns().addAll(roomIdCol, roomNumberCol, roomTypeInCol);

        Button back = new Button ("Back");
        back.setPrefWidth(150);
        back.setPrefHeight(30);
        back.setFont(Font.font("Roboto Blacak", FontWeight.BOLD, FontPosture.REGULAR, 20));
        back.setOnAction(this::processBackButtonForRooms);
    ...
    public static class Rooms
    {
    	 ...
    	 public Rooms(int roomIdIn, String roomNumberIn, String roomTypeIn)
    	 {
    	 	 this.roomId = new SimpleIntegerProperty(roomIdIn);
             this.roomNumber = new SimpleStringProperty(roomNumberIn);
             this.roomType = new SimpleStringProperty(roomTypeIn);
    	 }
    ...
    public void processBackButtonForRooms()
    {
    	intro = new Text("Room Selection");
        intro.setFont(Font.font("Roboto Blacak", FontWeight.BOLD, FontPosture.REGULAR, 60));
